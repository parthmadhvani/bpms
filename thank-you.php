...
<html lang="en">
  <head>
    <title>BarberKing-Thank You</title>
  ...
  <body>
    ...
    <section class="ftco-section ftco-no-pb mb-3">
    	<div class="container">
    		<div class="row no-gutters justify-content-center mb-5 pb-2">
          <div class="col-md-6 text-center heading-section ftco-animate">
          	<h4 class="w3ls_head">Thank you for choosing us, <strong>Please note down<br>your Appointment no or Take a Screenshot . Your Appointment no is <i><?php echo $_SESSION['aptno'];?></i></strong> </h4>
        </div>
    	</div>
    		...
    		<div class="row no-gutters">
    			<!-- <div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<a href="images/work-1.jpg" class="icon image-popup d-flex justify-content-center" >
