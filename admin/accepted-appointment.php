...
<html>
<head>
<title>BarberKing || Accepted Appointment</title>
...
if(isset($_POST["submit"])){
	...
	if($_POST["location"]=='All') $ret=mysqli_query($con,"select * from  tblappointment where Status='1'");

	else $ret=mysqli_query($con,"select * from  tblappointment where Location = '$location' and Status='1'");
}

else $ret=mysqli_query($con,"select * from  tblappointment where Status='1'");
