...
<html>
<head>
<title>BarberKing || New Appointment</title>
...
if(isset($_POST["submit"])){
	...
	if($_POST["location"]=='All') $ret=mysqli_query($con,"select * from  tblappointment where Status=''");

	else $ret=mysqli_query($con,"select * from  tblappointment where Location = '$location' and Status=''");
}

else $ret=mysqli_query($con,"select * from  tblappointment where Status=''");
